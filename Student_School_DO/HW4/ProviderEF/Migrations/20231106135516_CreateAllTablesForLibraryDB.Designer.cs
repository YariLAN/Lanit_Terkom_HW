...
namespace ProviderEF.Migrations
{
    ...
    [Migration("20231106135516_CreateAllTablesForLibraryDB")]
    partial class CreateAllTablesForLibraryDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookReader", b =>
                {
                    ...
                    b.Property<Guid>("ReadersReaderId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookReader", b =>
                {
                    b.HasOne("EntitiesEF.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EntitiesEF.Reader", null)
                        .WithMany()
